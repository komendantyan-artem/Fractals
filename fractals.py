...
150 150 0 -119.8076211353316
0 -119.8076211353316 -150 150
-150 150 150 150
...
text_helper.place(x=center*2+10, y=300)
button_help.place(x=center*2+10, y=630)
button_examples.place(x=center*2+10, y=660)
